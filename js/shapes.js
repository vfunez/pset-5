...
const drawTriangle = function() {
  ...
  let sideOne, sideTwo, sideThree, height, hypotenuse, base;
...
do {
    ...
    height = Math.min(sideOne, sideTwo, sideThree);
    hypotenuse = Math.max(sideOne, sideTwo, sideThree);
